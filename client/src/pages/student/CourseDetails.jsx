...
const CourseDetails = () => {
  ...
  const [courseData,setCousrseData]=useState(null)
  ...
  return courseData?(
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        <p className='pt-4 text-base text-sm' dangerouslySetInnerHTML={{__html: courseData.courseDescription.slice(0,200)}}></p>
        {/* reviews and ratings*/}
      <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
              ...
              <p className='text-sm'>Course by <span className='text-blue-600 underline'>Bhanu</span></p>
  ...
  <div className="p-5">
    ...
    <div className='flex gap-3 items-center pt-2'>
      <p className='text-gray-800 md:text-4xl font-semibold'>{currency} {(courseData.coursePrice-courseData.discount*courseData.coursePrice/100).toFixed(2) }</p>
    ...
    {/* Optionally: Add price/enroll button here */}
    {/* <button className="bg-blue-600 text-white px-4 py-2 rounded w-full mt-4">Enroll Now</button> */}
  </div>
</div>
